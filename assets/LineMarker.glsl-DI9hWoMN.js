import{vk as Z,FE as X,FF as ee,Eh as te,Ef as ie,FG as re,FH as ae,Em as o,Fx as se,EV as oe,Fw as ne,El as w,FI as ce,FJ as le,Ei as pe,Ek as de,En as he,Fg as ve,Ep as ue,FK as A,FL as N,FM as me,FN as fe,EZ as ge,f$ as Se,Eq as Pe,Er as ye,_ as _e,Es as C,Eu as R,Ev as we,Ew as U,Ex as W,E_ as ze,Ez as xe,EA as $e,EC as Te,Ey as be,ED as V,FO as Ve,FP as I,FQ as B,FR as ke,FS as Oe,FT as Fe,EE as De,n as p,EF as d,fY as Ee,F0 as Ce,FU as q,qt as We,Fo as Me,kK as Le,EK as je,cj as H,ck as Y,xc as Ae,gx as K,FV as Ne}from"./index-DM69G_LB.js";function G(r){const e=new Z,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(X,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
